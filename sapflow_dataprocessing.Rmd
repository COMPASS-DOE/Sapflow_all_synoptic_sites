...
#reading L2 dataset
#removing deep sensors for now and formating Sensor ID to merge later with tree sp
synoptic_full <- readRDS("synoptic_full_sap_clima.rds")%>%filter(Plot!="W",!Sensor_ID %in% c("01D", "02D", "03D", "04D", "05D", "06D", "07D", "08D")) %>% dplyr::select(-'sapflow-5cm') %>% mutate(Sensor_ID = str_pad(as.character(Sensor_ID), width = 2, pad = "0"))
  
#tree id data, .RDS lives in this repo , formating Sensor_Id to merge with sapflow data later
